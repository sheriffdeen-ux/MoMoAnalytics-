...
# Railway provides the PORT environment variable, so we bind to that.
CMD ["/home/appuser/.local/share/mise/installs/python/3.11.0/bin/gunicorn", "--bind", "0.0.0.0:$PORT", "final_system:app"]
